...
class TaskStore: ObservableObject {
	...
	func getCompleted(_ isCompleted: Bool) -> [Task]{
		!searchText.isEmpty ? tasks.filter{$0.isCompleted == isCompleted && $0.title.lowercased().contains(searchText.lowercased())} : tasks.filter{$0.isCompleted == isCompleted}
	}
